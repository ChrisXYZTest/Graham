...
class GoogleSuggest
{
    static void Main(string[] args)
    {
        ...
        FirefoxDriverService service = FirefoxDriverService.CreateDefaultService(@"C:\Users\Chris\source\repos\Graham\seleniumTest", "geckodriver.exe");
...
//Give the path of the Firefox Browser        
        ...
        using (IWebDriver driver = new FirefoxDriver(service))
        {
            ...
            IWebElement query = driver.FindElement(By.ClassName("_9nyy2"));
